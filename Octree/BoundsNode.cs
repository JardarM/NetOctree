...
namespace Octree
{
    ...
    public class BoundsNode<T>
    {
        ...
        /// Child nodes, if any
        /// </summary>
        private BoundsNode<T>[] _children;
        ...
        public BoundsNode(float baseLengthVal, float minSizeVal, float loosenessVal, Vector3 centerVal)
        {
        ...
        public void SetChildren(BoundsNode<T>[] childOctrees)
        {
        ...
        public BoundsNode<T> ShrinkIfPossible(float minLength)
        {
        ...
        private void Split()
        {
            ...
            _children = new BoundsNode<T>[8];
            _children[0] = new BoundsNode<T>(
                newLength,
                _minSize,
                _looseness,
                Center + new Vector3(-quarter, quarter, -quarter));
            _children[1] = new BoundsNode<T>(
                newLength,
                _minSize,
                _looseness,
                Center + new Vector3(quarter, quarter, -quarter));
            _children[2] = new BoundsNode<T>(
                newLength,
                _minSize,
                _looseness,
                Center + new Vector3(-quarter, quarter, quarter));
            _children[3] = new BoundsNode<T>(
                newLength,
                _minSize,
                _looseness,
                Center + new Vector3(quarter, quarter, quarter));
            _children[4] = new BoundsNode<T>(
                newLength,
                _minSize,
                _looseness,
                Center + new Vector3(-quarter, -quarter, -quarter));
            _children[5] = new BoundsNode<T>(
                newLength,
                _minSize,
                _looseness,
                Center + new Vector3(quarter, -quarter, -quarter));
            _children[6] = new BoundsNode<T>(
                newLength,
                _minSize,
                _looseness,
                Center + new Vector3(-quarter, -quarter, quarter));
            _children[7] = new BoundsNode<T>(
                newLength,
                _minSize,
                _looseness,
                Center + new Vector3(quarter, -quarter, quarter));
        ...
        private void Merge()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                BoundsNode<T> curChild = _children[i];
        ...
        private bool ShouldMerge()
        {
            ...
            if (_children != null)
            {
                foreach (BoundsNode<T> child in _children)
                {
